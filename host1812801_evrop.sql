...
--
-- Хост: localhost
-- Время создания: Авг 25 2020 г., 17:46
...
(20, 'Оставляю крутой отзыв. Все было очень круто. Всем советую', 'Джордж Клуни'),
(21, 'Оставляю крутой отзыв. Все было очень круто. Всем советую', 'Джордж Клуни');
