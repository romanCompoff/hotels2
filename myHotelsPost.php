...
$headers .= "From: Виталий Дорохин <voronezhotdelka@gmail.com>\r\n"; // от кого письмо
$result =  $mailSMTP->send('s1te@bk.ru', 'Обратная связь с сайта', 'Уважаемая Администация сайта, вам отправлено письмо через форму обратной связи.
<br>Имя: ' . $name . '
